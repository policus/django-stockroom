...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Color.swatch'
        db.alter_column('stockroom_color', 'swatch', self.gf('stockroom.thumbs.ImageWithThumbsField')(max_length=100, null=True))

        # Changing field 'Brand.logo'
        db.alter_column('stockroom_brand', 'logo', self.gf('stockroom.thumbs.ImageWithThumbsField')(max_length=100, null=True))

        # Changing field 'ProductImage.image'
        db.alter_column('stockroom_productimage', 'image', self.gf('stockroom.thumbs.ImageWithThumbsField')(max_length=100, sizes=((264, 340),)))


    def backwards(self, orm):
        
        # Changing field 'Color.swatch'
        db.alter_column('stockroom_color', 'swatch', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Brand.logo'
        db.alter_column('stockroom_brand', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'ProductImage.image'
        db.alter_column('stockroom_productimage', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
    ...
    models = {
        ...
        'stockroom.brand': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('stockroom.thumbs.ImageWithThumbsField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        'stockroom.color': {
            ...
            'swatch': ('stockroom.thumbs.ImageWithThumbsField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        'stockroom.inventory': {
        ...
        'stockroom.productimage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('stockroom.thumbs.ImageWithThumbsField', [], {'max_length': '100', 'sizes': '((264, 340),)'})
        },
