...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('stockroom_productgallery', (
            ...
            ('images_available', self.gf('django.db.models.fields.IntegerField')(default=10)),
        ...
        db.create_table('stockroom_productimages', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('stockroom', ['ProductImages'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('stockroom_productimages')
