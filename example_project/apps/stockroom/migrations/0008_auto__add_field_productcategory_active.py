...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductCategory.active'
        db.add_column('stockroom_productcategory', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ProductCategory.active'
        db.delete_column('stockroom_productcategory', 'active')
